...
if __name__ == "__main__":
    main_arg = parse_args(sys.argv[1:])
    credits = main_arg.credits
    nonresident = main_arg.nonresident
    df_tuition = main_arg.differentialtuition
    
    resident = not nonresident
    money = calculate_tuition(credits, resident, df_tuition)

    print("Your tuition and fees total $", money)